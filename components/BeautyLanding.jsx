  ...
  const fillerServices = [
    {
      ...
      features: ["Elmacik kemikleri", "Dudak dolgusu", "Yuz hacmi", "Dogal gorunum"]
    }
  ];
  ...
  const wrinkleServices = [
    {
      ...
      icon: "✨",
      description: "Yuz kaslarinin tekrarlayan hareketlerinden kaynaklanan mimik cizgileri; alin, kas arasi ve goz cevresinde belirgin hale gelir. Medikal estetik yontemler sayesinde cildiniz eski elastikiyetine kavusur.",
      features: []
    }
  ];
  ...
  const mimikServices = [
    {
      ...
      icon: "😊",
              description: "Kirisikliklarin gorunumunu azaltmaya yonelik enjeksiyon uygulamasi ile cilt yuzeyi daha puruzsuz ve dinlenmis gorunur. Tekrarlanabilir uygulama ile belirli araliklarla yenilenebilir.",
      features: ["Mimik cizgileri", "Dinlenmis gorunum", "Puruzsuz cilt", "Tekrarlanabilir uygulama"]
    }
  ];

  const benefits = [
    "Uzman doktorlar eşliğinde kişiye özel planlama",
    "Dogal gorunumlu ve dengeli sonuclar", 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Zamanla yuzumuzde beliren ince cizgiler ve hacim kayiplari sizi rahatsiz mi ediyor? 
                Kisiye gore belirlenen estetik uygulamalarla daha genc, canli ve dinlenmis bir gorunume kavusmaniz artik cok kolay!
              </p>
            ...
            {wrinkleServices.map((service, index) => (
              ...
              >
                  ...
                  {service.title}
                      ...
                      Yuz kaslarinin tekrarlayan hareketlerinden kaynaklanan mimik cizgileri; alin, kas arasi ve goz cevresinde belirgin hale gelir. 
                </p>
       ...
       <div className="container mx-auto px-4">
        ...
        <div className="md:flex md:justify-center">
          <div className="overflow-x-auto pb-4 md:overflow-visible">
            <div className="flex space-x-6 md:grid md:grid-cols-2 md:gap-6 md:max-w-4xl">
            ...
            <div className="w-80 flex-shrink-0 md:w-full">
              <div className="bg-white rounded-2xl shadow-lg p-4">
                ...
                <div className="mt-3 text-center">
                  ...
                  <p className="text-xs text-slate-500">Dogal Gorunum</p>
                </div>
              </div>
            </div>
            ...
            <div className="w-80 flex-shrink-0 md:w-full">
              <div className="bg-white rounded-2xl shadow-lg p-4">
                ...
                <div className="mt-3 text-center">
                  <p className="text-sm font-medium text-slate-700">Mimik Cizgileri</p>
        ...
        <div className="container mx-auto px-4">
         ...
         <div className="md:flex md:justify-center">
           <div className="overflow-x-auto pb-4 md:overflow-visible">
             <div className="flex space-x-6 md:grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 md:gap-6 md:max-w-6xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl">
                  ...
                  <a
                     ...
                     href="https://wa.me/905438999586?text=Merhaba, ucretsiz danismanlik almak istiyorum."
                     target="_blank"
